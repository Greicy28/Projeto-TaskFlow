    ...
    <div className="min-h-screen bg-purple-50 p-6">
      <div className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-lg">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-purple-600">Tarefas</h2>
          <button
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <select
            ...
            value={filter}
            className="border border-purple-300 rounded px-2 py-1 focus:ring-purple-500 focus:border-purple-500"
          >
        ...
        <ul className="mt-6 space-y-4">
          {tasks.length === 0 ? (
            ...
            tasks.map(task => (
              <li key={task.id} className="flex justify-between items-center bg-purple-50 p-3 rounded border border-purple-200">
                <div>
